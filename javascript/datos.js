...
const inventariodatos = [
  ...
  { idProducto: 2, idprovedor: 2, cantidad: 1, nombre: "chokis"},
  { idProducto: 3, idprovedor: 3, cantidad: 67, nombre: "pan blanco chico"},
  { idProducto: 4, idprovedor: 4, cantidad: 45, nombre: "leche de galon"},
  { idProducto: 5, idprovedor: 5, cantidad: 50, nombre: "pepsi de 1.5 litros"},
];
